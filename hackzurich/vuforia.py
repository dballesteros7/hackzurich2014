...
def main():
    v = Vuforia(access_key="448a82a80ed4a92102d67526b1b569ed32c2a23e",
                secret_key="7cde51e22487137e42099d025e4e33c1011d3c46")
    for target in v.get_targets():
        print target

    image_file = open('/home/diegob/Pictures/image-cloud.jpg')
    image = base64.b64encode(image_file.read())
    #metadata_file = open('PATH_TO_METADATAFILE')
    #metadata = base64.b64encode(metadata_file.read())
    print v.add_target({"name": "testimage", "width": 32.0, "image": image, "active_flag": 1})
